  ...
  <section class="ftco-section ftco-services py-5 pb-5">
    <div class="col-md-10 mx-auto font-ubuntu pb-5">
      <div class="row">
        <div class="col-sm-12 col-12 ">
         <nav aria-label="">
           <ol class="breadcrumb" style="background-color: transparent;">
             ...
             <li class="breadcrumb-item" aria-current="page"><a href="<?php echo base_url('Faq/payment') ?>" class="text-black font-bold-7">Info Payment</a></li>
           </ol>
         </nav>
       </div>
        ...
        <div class="col-md-12">
          <p class="font-24">Info Payment</p>
        </div>
      </div>
    </div>
            ...
            <div class="info1">
              <div class="" id="headingOne">
                <h2 class="mb-0">
                  ...
                  Apa saja metode pembayaran yang digunakan pada Telemedicine App?
                  </button>
                </h2>
              </div>
              ...
              <div id="info1" class="collapse show" aria-labelledby="headingOne" data-parent="#info">
                <div class="pl-3 ml-3 mb-3 font-18 text-justify">
                  Metode pembayaran yang digunakan beragam yaitu menggunakan Kartu kredit/debit, transfer bank, virtual account, ovo, owlexa, dan IMkas.
                </div>
              </div>
            </div>
            <div class="info2">
              <div class="" id="headingTwo">
                <h2 class="mb-0">
                  <button class="btn btn-faq btn-block text-left" type="button" data-toggle="collapse" data-target="#info2" aria-expanded="false" aria-controls="info2"><i class="fas fa-caret-down"></i>
                    Bagaimana jika terdapat kendala dalam proses pembayaran?
                  </button>
                </h2>
              </div>
              <div id="info2" class="collapse" aria-labelledby="headingTwo" data-parent="#info">
                <div class="pl-3 ml-3 mb-3  font-18 text-justify">
                  Jika menggunakan payment gateway, maka mengikuti kebijakan SOF tersebut, dengan bantuan dari Indosat Ooredoo yang mengkomunikasikan kepada Payment Gateway setelah mendapatkan laporan dari customer care Indosat Ooredoo melalui Rumah Sakit.
                </div>
              </div>
            </div>
            <div class="info3">
              ...
              <div id="info3" class="collapse" aria-labelledby="headingThree" data-parent="#info">
                <div class="pl-3 ml-3 mb-3  font-18 text-justify">
                  Dapat melakukan kembali transaksi pembayaran, jika masih tidak bisa dapat menghubungi call center yang tersedia.
                </div>
              </div>
            </div>
          </div>
