...
<aside class="main-sidebar sidebar-light-info elevation-4 bg-light-blue">
    <!-- Brand Logo -->
    <a href="<?php echo base_url('dokter/Dashboard') ?>" class="brand-link" style="text-align: center;">
    ...
    <div class="sidebar">
      <div class="user-panel pb-3 pt-3 mb-3 d-flex">
        ...
        <div class="info" style="font-family:verdana,helvetica; font-weight: bold; margin-top: -5px">
          <a href="<?php echo base_url('dokter/Profile') ?>" class="d-block" align="center" style="color: #545454; " ><?php echo ucwords($user->name) ?></a>
          <a href="<?php echo base_url('dokter/Profile') ?>" class="d-block" align="left" style=" color: #545454;font-size: 11px" >Profile</a>
        </div>
      </div>
    ...
    <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            <a href="<?php echo base_url('dokter/Dashboard') ?>" class="nav-link active-menu">
          ...
          <li class="nav-item has-treeview ">
            <a href="<?php echo base_url('dokter/Profile') ?>" class="nav-link">
          ...
          <li class="nav-item has-treeview ">
            <a href="<?php echo base_url('dokter/KonfigurasiAkun') ?>" class="nav-link">
