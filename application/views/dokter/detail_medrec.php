          ...
          <div class="row">
            ...
            <div class="col-md-12 font-14 font-bold-4">
              <div class="form-group row">
                  ...
                  <div class="col-md-10 col-10">
                      <p>: <?php echo $rekam_medis->diagnosis_code ? '('.$rekam_medis->diagnosis_code.') '.$rekam_medis->diagnosis:'-' ?></p>
                  </div>
                  <label class="col-md-2 col-4">Planning</label>
                  <div class="col-md-10 col-10">
                      <p>: <?php echo $rekam_medis->planning ? $rekam_medis->planning:'-' ?></p>
                  </div>
                  <label class="col-md-2 col-4">Pemeriksaan</label>
                  <div class="col-md-10 col-10">
                      <p>: <?php echo $rekam_medis->laboratorium || $rekam_medis->radiologi ? '('.implode(',', array(($rekam_medis->laboratorium ? 'Laboratorium':null), ($rekam_medis->radiologi ? 'Radiologi':null))).')<br/>&nbsp;&nbsp;'.$rekam_medis->pemeriksaan:'-' ?></p>
                  </div>
                  <label class="col-md-2 col-4">Kesimpulan</label>
                  <div class="col-md-10 col-10">
                      <p>: <?php echo $rekam_medis->kesimpulan ? $rekam_medis->kesimpulan:'-' ?></p>
                  </div>
                  <?php
                    $tanggal_lahir = new DateTime($rekam_medis->tanggal_lahir_pasien);
                    $tanggal_lahir = $tanggal_lahir->format('d-m-Y');
                  ...
                  <label class="col-md-1 col-1" style="max-width:1px;">: </label>
                  <div class="col-md-9 col-9" style="margin-left:-3rem">
