      ...
      <div class="row">
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-body">
              <form action="<?php echo base_url('dokter/Profile/update');?>" method="post" enctype="multipart/form-data">                     
                <div class="col-lg-6">
                  <div class="row">
                    <div class="col-lg-6">
                    ...
                    <div class="col-lg-6">
                      ...
                      <div class="form-group">
                        ...
                        <?php foreach($list_poli as $poli){ ?>
                          <option value="<?php echo $poli->id ?>" <?php if($detail_dokter){echo $poli->id == $detail_dokter->id_poli ? 'selected' : '';} ?>><?php echo $poli->poli ?></option>
                        <?php } ?>
                        </select>
                      </div>
                      <div class="form-group">
                      <label>Pengalaman : </label>
                      <input required="" class="form-control" name="pengalaman" value="<?php if($detail_dokter){echo $detail_dokter->pengalaman_kerja; } ?>">
                     </div>
                    </div>
                  </div>                                  
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        <center>
                        <a href="<?php echo base_url('dokter/Profile/update');?>" style="text-decoration:none;color: #fff">
