  ...
  <div class="content">
      ...
      <div class="row">
        <div class="col-lg-12">  
          <?= form_open_multipart('dokter/Profile/update'); ?> 
            ...
            <div class="row">
              <div class="col-md-4">
                <div class="form-group form-focus">
                    ...
                    <input type="text" class="form-control floating" name="str" value="<?php echo $user->str;?>" readonly disabled="disabled" placeholder="STR">
                </div>
              </div> 
              <div class="col-md-4">
                <div class="form-group form-focus">
                    <label class="focus-label">Poli</label>
                    <input type="text" class="form-control floating" readonly disabled value="<?php echo $detail_dokter->poli ?>" placeholder="Masukan Poli Disini">
                      <!-- <select class="form-control floating"  name="poli" readonly disabled="disabled">
                          <?php //foreach($list_poli as $poli){ ?>
                            <option value="<?php //echo $poli->id ?>" <?php //if($detail_dokter){echo $poli->id == $detail_dokter->id_poli ?<?php //echo $poli->poli ?></option>
                          <?php //} ?>
                      </select> -->
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-group form-focus">
                    ...
                    <input type="date" class="form-control floating" name="pengalaman" readonly disabled="disabled" value="<?php if($detail_dokter){echo $detail_dokter->pengalaman_kerja; } ?>">
              </div> 
            </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-4">
                <div class="form-group form-focus">
                    ...
                    <input required type="text" class="form-control floating" name="name" value="<?php echo ucwords($user->name);?>">
                </div>
              </div> 
              <div class="col-md-4">
                <div class="form-group form-focus">
            ...
            <div class="row mt-5">
              <div class="mx-auto">
                ...
                <a href="<?php echo base_url('dokter/profile') ?>"><button type="button" class="btn btn-batal ml-4"  id="btn-add-admin">Batal</button></a>
              </div>
            </div>
          <?= form_close(); ?>
        </div>
