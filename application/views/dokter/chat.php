...
<!-- Main content -->
        ...
        <div class="col-sm-12 col-12 ">
          <nav aria-label="">
              <ol class="breadcrumb" style="background-color: transparent;">
                  <li class="breadcrumb-item active"><a href="<?php echo base_url('pasien/Dashboard');?>"class="text-black">Dashboard</a></li>
                  ...
                  <li class="breadcrumb-item" aria-current="page"><a href=""class="text-black font-bold-7">Chat Dokter</a></li>
              </ol>
          </nav>
        </div>
        <div class="col-sm-12 col-12">
            <h3 class="page-title">Chat dengan Pasien <?= $pasien->name ?></h3>
        </div>
      </div>
  ...
  <?php $foto_dokter = $pasien->foto ? base_url('assets/images/users/' . $pasien->foto) : base_url('assets/telemedicine/img/default.png'); ?>
  <script>
      chat_locate = 'dokter';
