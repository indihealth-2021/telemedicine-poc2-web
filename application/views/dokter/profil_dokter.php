                                    ...
                                    <div class="row">
                                        <div class="col-md-5 col-12">
                                            <div class="profile-info-left">
                                                ...
                                                <small class="text-subprofil">STR : <?php noxss($user->str);?></small><br>
                                                <small class="text-subprofil">Poli : <?php if($detail_dokter){noxss($detail_dokter->poli);}?></small><br>
                                                <small class="text-subprofil">Pengalaman dari : <?php if($detail_dokter){noxss((new DateTime($detail_dokter->pengalaman_kerja))->format('d-m-Y'));}?></small>
                                                <div class="mt-3">
