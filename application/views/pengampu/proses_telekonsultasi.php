                                            ...
                                            <tbody>
                                                <?php foreach($list_rm as $idx=>$rm){ ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo $rm->tanggal_konsultasi ?></td>
                                                        <td><?php echo $rm->poli ?></td>
                                                        <td><?php echo $rm->diagnosis ?></td>
                                                        <td class="text-center"><a target="_blank" href="<?php echo base_url('pengampu/RekamMedis/detail/'.$rm->id_pasien.'/'.$rm->id_jadwal_konsultasi) ?>" class="text-detail font-14">Lihat Detail</a></td>
                                                    </tr>
                                                <?php } ?>
                                            </tbody>
                                    </table>
                        ...
                        <div class="font-12">
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" class="form-control-plaintext" id="pasien" value="<?php echo $nama_pasien ?>" name="" disabled readonly>
                                    </div>  
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" class="form-control-plaintext" id="usia" value="<?php echo $usia_pasien ?> Tahun" name="" disabled readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" readonly class="form-control-plaintext" id="" value="<?php echo ucwords($diampu->name) ?>" name="">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" id="dokter_diampu" value="<?php echo $dokter_diampu ?>" name="dokter_diampu" disabled>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" id="dokter_pengampu" value="" name="dokter_pengampu">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="font-12">
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <textarea rows="4" class="font-12 form-control floating" id="catatan_diampu" value="" name="catatan_diampu" disabled></textarea>
                                    </div>
                                </div>
                            </div>
                           <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <textarea rows="4" class="font-12 form-control floating" id="catatan_pengampu" value="" name="catatan_pengampu"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php $foto_dokter = $diampu->foto ? base_url('assets/images/users/' . $diampu->foto) : base_url('assets/telemedicine/img/default.png'); ?>
<script>
    chat_locate = 'pasien';
    user_kategori = 'pasien';
    id_pasien = <?php echo $user->id ?>;
    id_dokter = <?php echo $diampu->id ?>;
