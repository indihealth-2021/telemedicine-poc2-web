  ...
  <section class="ftco-section ftco-services py-5 pb-5">
    <div class="col-md-10 mx-auto font-ubuntu pb-5">
      <div class="row">
        <div class="col-sm-12 col-12 ">
         <nav aria-label="">
           <ol class="breadcrumb" style="background-color: transparent;">
             ...
             <li class="breadcrumb-item" aria-current="page"><a href="<?php echo base_url('Faq/konsultasi') ?>" class="text-black font-bold-7">Info Konsultasi</a></li>
           </ol>
         </nav>
       </div>
        ...
        <div class="col-md-12">
          <p class="font-24">Info Konsultasi</p>
        </div>
      </div>
    </div>
            ...
            <div class="info1">
              <div class="" id="headingOne">
                <h2 class="mb-0">
                  <button class="btn btn-faq btn-block text-left" type="button" data-toggle="collapse" data-target="#info1" aria-expanded="true" aria-controls="info1"><i class="fas fa-caret-down"></i>
                    Bagaimana cara menggunakan fitur Konsultasi dengan Dokter?
                  </button>
                </h2>
              </div>
              ...
              <div id="info1" class="collapse show" aria-labelledby="headingOne" data-parent="#info">
                <div class="pl-3 mb-3 font-18 text-justify">
                  <span class="ml-3">Konsultasi dengan Dokter melalui empat tahap sebagai berikut:</span>
                  <ul>
                    <li>Melakukan pendaftaran: memilih dokter pada menu pendaftaran.</li>
                    <li>Klik tombol daftar konsultasi, akan diarahkan pada halaman profil dokter.</li>
                    <li>Klik tombol daftar konsultasi.</li>
                    <li>Melakukan pembayaran: klik cek status pendaftaran.</li>
                    <li>Klik bayar.</li>
                    <li>Pilih metode pembayaran.</li>
                    <li>Upload bukti pembayaran.</li>
                    <li>Menunggu pembayaran di validasi.</li>
                    <li>Mengisi assessment: klik isi assessment.</li>
                    <li>Pilih assessment terkait.</li>
                    <li>Isi pertanyaan kuesioner assessment.</li>
                    <li>Klik tombol kirimkan.</li>
                    <li>Setelah semua tahap diselesaikan, jadwal konsultasi dengan dokter akan muncul di menu Jadwal Telekonsultasi dan dokter terkait akan melakukan panggilan.</li>
                  </ul>
                </div>
              </div>
            </div>
              ...
              <div class="" id="headingTwo">
                <h2 class="mb-0">
                  <button class="btn btn-faq btn-block text-left" type="button" data-toggle="collapse" data-target="#info2" aria-expanded="false" aria-controls="info2"><i class="fas fa-caret-down"></i>
                    Bagaimana cara pasien mengetahui background detail dokter yang akan dihubungi?
                  </button>
                </h2>
              </div>
              <div id="info2" class="collapse" aria-labelledby="headingTwo" data-parent="#info">
                <div class="pl-3 ml-3 mb-3  font-18 text-justify">
                  Dengan melihat profil dokter pada menu dokter di halaman utama.
                </div>
              </div>
            </div>
            <div class="info3">
              <div class="" id="headingThree">
                <h2 class="mb-0">
                  <button class="btn btn-faq btn-block text-left" type="button" data-toggle="collapse" data-target="#info3" aria-expanded="false" aria-controls="info3"><i class="fas fa-caret-down"></i>
                    Apakah pasien dapat meminta dokter di layanan Konsultasi untuk menjelaskan diagnosis yang pasien dapatkan dari dokter lain, misalnya hasil rontgen/hasil lab?
                  </button>
                </h2>
              </div>
              <div id="info3" class="collapse" aria-labelledby="headingThree" data-parent="#info">
                <div class="pl-3 ml-3 mb-3  font-18 text-justify">
                  Ya, penjelasan diagnosis dapat diminta melalui video conference atau melalui chat saat konsultasi berlangsung.
                </div>
              </div>
            </div>
            <div class="info4">
              <div class="" id="headingFour">
                <h2 class="mb-0">
                  ...
                  Bagaimana jika saat konsultasi dengan dokter terhenti tiba-tiba?
                  </button>
                </h2>
              </div>
              <div id="info4" class="collapse" aria-labelledby="headingFour" data-parent="#info">
                <div class="pl-3 ml-3 mb-3  font-18 text-justify">
                  Dokter dapat melakukan panggilan ulang selama belum diselesaikan konsultasi nya.
                </div>
              </div>
            </div>
          </div>
