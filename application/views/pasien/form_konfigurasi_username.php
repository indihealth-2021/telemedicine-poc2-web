  ...
  <div class="content">
          ...
          <div class="col-sm-12 col-12 ">
            <nav aria-label="">
                <ol class="breadcrumb" style="background-color: transparent;">
                    ...
                    <li class="breadcrumb-item" aria-current="page"><a href="<?php echo base_url('pasien/KonfigurasiAkun/form_username'); ?>"class="text-black font-bold-7">Edit Akun</a></li>
                </ol>
            </nav>
          </div>
      </div> 
      <div class="row">
        <div class="col-lg-12">
        <?= form_open('pasien/KonfigurasiAkun/update_username'); ?>
