...
<div class="page-wrapper">
  <div class="content">
          ...
          <div class="col-sm-12 col-12 ">
            <nav aria-label="">
                <ol class="breadcrumb" style="background-color: transparent;">
                    ...
                    <li class="breadcrumb-item" aria-current="page"><a href="<?php echo base_url('pasien/Profile') ?>"class="text-black font-bold-7">Pengaturan</a></li>
                </ol>
            </nav>
          </div>
          <div class="col-sm-12 col-12">
      ...
      <div class="card-box-profile profile-header">
                                    ...
                                    <div class="row">
                                        <div class="col-md-5 col-12 mt-3">
                                            <div class="profile-info-left">
                                                <h3 class="user-name m-t-0 mb-0 text-profil"><b><?php echo ucwords(noxss($user->name)) ?></b></h3>
                                                <small class="text-subprofil">Pasien</small><br>
                                                <small class="text-subprofil">No Rekam Medis : <?php noxss($no_medrek ? $no_medrek->no_medrec : '-') ?></small>
                                                <div class="mt-3">
                                                  <a href="<?php echo base_url('pasien/Profile/edit');?>"><button type="button" class="btn btn-edit-profile"  id="btn-add-admin">Edit Profile</button></a>
                                                  <a href="<?php echo base_url('pasien/KonfigurasiAkun'); ?>"><button type="button" class="btn btn-edit-profile"  id="btn-add-admin">Edit Akun</button></a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-7 col-12 mt-3">
                                            <ul class="personal-info text-info-left">
                                                <li>
                                                    <span><?php noxss($user->email);?></span>
                                                </li>
                                                <li>
                                                    <span><?php noxss($user->telp);?></span>
                                                </li>
                                                <li>
                                                    <span><?php noxss($user->jenis_kelamin);?></span>
                                                </li>
                                                <li>
                                                    <span><?php noxss('Jalan '.ucwords(strtolower($user->alamat_jalan)).', Kel '.ucwords(strtolower($user->nama_kelurahan)).', Kec '.ucwords(strtolower($user->nama_kecamatan)).', Kab/Kota '.ucwords(strtolower($user->nama_kota)).', Kode Pos '.$user->kode_pos.', Provinsi '.ucwords(strtolower($user->nama_provinsi))) ?></span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
            ...
            <div class="row">
              <div class="col-md-4">
                <a href="<?php echo base_url('pasien/KonfigurasiAkun'); ?>"><button type="button" class="btn btn-edit-akun"  id="btn-add-admin">Edit Akun</button></a>
              </div>
            </div> -->
  </div>
</div>  