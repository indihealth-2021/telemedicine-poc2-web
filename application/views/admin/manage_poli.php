  ...
  <div class="content">
      <div class="row mb-4">
          <div class="col-sm-12 col-12 ">
            <nav aria-label="">
                <ol class="breadcrumb" style="background-color: transparent;">
                    ...
                    <li class="breadcrumb-item" aria-current="page"><a href="<?php echo base_url('admin/Config/poli') ?>" class="text-black font-bold-7">Poli</a></li>
                </ol>
            </nav>
          </div>
          <div class="col-sm-12 col-12">
          ...
          <div class="col-sm-12 col-12">
              <h7 class="page-subtitle">Poli</h7>
          </div>
      </div>
                ...
                <div class="col-md-12">
                  <div class="box">
                      <div class="container-1">
                          ...
                          <input type="search" id="search" style="background: #ffffff !important;" placeholder="Cari Poli Disini" />
                      </div>
                    </div>
                  <div class="">
                      <a href="<?php echo base_url('admin/Config/formAddPoli') ?>" class="btn btn btn-tele btn-rounded float-right  "><i class="fa fa-plus"></i> Tambah Poli</a>
                  </div>
                          ...
                          foreach ($poli as $data) {
                            ...
                            <tr class="odd gradeX">
                              ...
                              <!-- <td class="text-center">
                                <?php echo $data->aktif ? '<button type="button" class="btn-status status-aktif" data-toggle="modal" data-status-poli="aktif" data-nama-poli="'.$data->name_poli.'" data-id-poli="'.$data->id.'" data-target="#modalStatusPoli">Aktif</button>':'<button type="button" class="btn-status status-nonaktif" data-toggle="modal" data-status-poli="nonaktif" data-nama-poli="'.$data->name_poli.'" data-id-poli="'.$data->id.'" data-target="#modalStatusPoli">Nonaktif</button>' ?>
                                <center><small class="text-muted">klik untuk mengubah status</small></center>
                              </td> -->
                          <td>
                              <a class="font-icon" href="#modalHapus" data-toggle="modal" data-href="<?php echo base_url('admin/Config/deletePoli/'.$data->id) ?>" data-nama="<?php echo $data->name_poli ?>" onclick="$('#modalHapus #form')" >
                              ...
                              <a class="mx-3" href="<?php echo base_url('admin/Config/formEditPoli/'.$data->id) ?>">
                                <i><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
  ...
  <div class="modal-dialog  modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title font-modal-header p-3">Hapus Data Poli</h5>
      </div>
      <form method="post" action="<?php echo base_url('admin/Config/deletePoli/'.$data->id) ?>">
      <div class="modal-body font-modal-body">
          <p class="p-3">Anda yakin ingin menghapus data poli <b id="nama"></b> ?</p>
      </div>
...
<div class="modal fade" id="modalStatusPoli" tabindex="-1" role="dialog">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body font-modal-body">
        <p class="p-3">Apa anda yakin ingin <span class="status-poli"></span> <b class="nama-poli"></b>?</p>
      </div>
      <div class="modal-footer">
        <div class="mx-auto">
          <a href="" class="btn btn-ya" id="buttonHapus">Ya</a>
