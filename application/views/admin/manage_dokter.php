  ...
  <div class="content">
      <div class="row mb-4">
          <div class="col-sm-12 col-12 ">
            <nav aria-label="">
                <ol class="breadcrumb" style="background-color: transparent;">
                    ...
                    <li class="breadcrumb-item" aria-current="page"><a href="<?php echo base_url('admin/dokter') ?>" class="text-black font-bold-7">User Management</a></li>
                </ol>
            </nav>
          </div>
          <div class="col-sm-12 col-12">
          ...
          <div class="col-sm-12 col-12">
              <h7 class="page-subtitle">Dokter</h7>
          </div>
      </div>  
        ...
        <div class="row">
          <div class="col-md-12">
            <!-- <ul class="nav nav-tabs nav-tabs-bottom">
                <li class="nav-item"><a class="nav-link active" href="" data-toggle="tab">Dokter</a></li>
            </ul> -->
            <div class="bg-tab px-3">
              <div class="tab-pane show pt-3" id="admin">
                <div class="col-md-12">
                  ...
                  <div class="">
                      <a href="<?php echo base_url('admin/Dokter/form_dokter') ?>" class="btn btn btn-tele btn-rounded float-right  "><i class="fa fa-plus"></i> Tambah Dokter</a>
                  </div>
                  ...
                  <tr>
                    ...
                    <td>
                      <?php echo ucwords($dokter->name) ?><br>
                      <span class="font-12"><?php echo $dokter->poli_aktif ? strtoupper($dokter->poli):'<font color="red" title="POLI TIDAK AKTIF">'.strtoupper($dokter->poli).'</font>' ?></span>
                    </td>
                    ...
                    <td class="text-center"><?php echo $dokter->aktif == 1 ? '<span class="status-aktif">Aktif</span>' : '<span class="status-nonaktif">Tidak Aktif</span>' ?></td>
                    <td width="10%"> 
                                <a class="font-icon" href="#modalHapus" data-toggle="modal" data-href="<?php echo base_url('admin/Dokter/hapusDokter/'.$dokter->id);?>" data-nama="<?php echo $dokter->name ?>" onclick="$('#modalHapus #form')" >
                              ...
                              <a class="mx-3" href="<?php echo base_url('admin/Dokter/tampilEditDokter/'.$dokter->id);?>"><!-- <i class="fas fa-pen font-16"></i> -->
                                  <i><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title font-modal-header p-3">Hapus Data Dokter</h5>
      </div>
      <form method="post" action="<?php echo base_url('admin/Dokter/hapusDokter/'.$dokter->id);?>">
      <div class="modal-body font-modal-body">
          <p class="p-3">Anda yakin ingin menghapus data dokter <b id="nama"></b> ?</p>
      </div>
