  ...
  <div class="content">
      <div class="row mb-4">
          <div class="col-sm-12 col-12 ">
            <nav aria-label="">
                <ol class="breadcrumb" style="background-color: transparent;">
                    ...
                    <li class="breadcrumb-item" aria-current="page"><a href="<?php echo base_url('admin/dokter/jadwal_dokter') ?>" class="text-black font-bold-7">Jadwal</a></li>
                </ol>
            </nav>
          </div>
          <div class="col-sm-12 col-12">
          ...
          <div class="col-sm-12 col-12">
              <h5 class="page-subtitle">Jadwal Dokter</h3>
          </div>
      </div>  
        ...
        <div class="row">
          <div class="col-md-12">
            <!-- <ul class="nav nav-tabs-lg nav-tabs-bottom">
                <li class="nav-item"><a class="nav-link active pl-5" href="#jadwal-dokter" data-toggle="tab">Jadwal Dokter</a></li>
            </ul> -->
                ...
                <div class="col-md-12">
                  <div class="box">
                      <div class="container-1">
                          ...
                          <input type="search" id="search" style="background: #ffffff !important;" placeholder="Cari Dokter Disini" />
                      </div>
                    </div>
                  <div class="">
                      <a href="<?php echo base_url('admin/Dokter/form_jadwalDokter') ?>" class="btn btn btn-tele btn-rounded float-right  "><i class="fa fa-plus"></i> Tambah Jadwal</a>
                  </div>
                    ...
                    <table class="table table-border table-hover custom-table mb-0" id="table_jadwal_dokter">
                      ...
                      <tbody class="font-14">
                        ...
                        for($i = 0; $i<count($jadwal);$i++) {
                          ...
                          <tr class="odd gradeX">   
                              <td><?php echo $i+1; ?></td>       
                              <td><?php echo $jadwal[$i]->user_aktif ? ucwords($jadwal[$i]->name) : ucwords($jadwal[$i]->name).' <span class="badge badge-danger">Tidak Aktif</span>'; ?></td>
                              <td><?php echo $jadwal[$i]->poli ?> <?php echo $jadwal[$i]->poli_aktif ? '':'<span class="badge badge-danger">Tidak Aktif</span>'; ?></td>
                              ...
                              <td class="text-center"><?php echo $jadwal[$i]->jadwal_aktif == 1 ? '<span class="status-aktif">Aktif</span>' : '<span class="status-nonaktif">Tidak Aktif</span>' ?></td>
                          <td> 
                            <a class="font-icon" href="#modalHapus" data-toggle="modal" data-href="<?php echo base_url('admin/Dokter/hapus_jadwalDokter/'.$jadwal[$i]->id) ?>" data-nama="<?php echo $jadwal[$i]->name ?>" onclick="$('#modalHapus #form')" >
                            ...
                            <a class="mx-3" href="<?php echo base_url('admin/Dokter/tampilEdit_jadwalDokter/'.$jadwal[$i]->id) ?>">
                              <i><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
  ...
  <div class="modal-dialog  modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title  font-modal-header p-3"">Hapus Data Jadwal Dokter</h5>
      </div>
      <div class="modal-body font-modal-body">
          <p class="p-3">Anda yakin ingin menghapus data jadwal dokter <b id="nama"></b> ?</p>
      </div>
