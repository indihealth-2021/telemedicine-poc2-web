          ...
          <div class="col-sm-12 col-12 ">
            <nav aria-label="">
                <ol class="breadcrumb" style="background-color: transparent;">
                    ...
                    <li class="breadcrumb-item" aria-current="page"><a href="<?php echo base_url('admin/pasien') ?>" class="text-black font-bold-7">User Management</a></li>
                </ol>
            </nav>
          </div>
          <div class="col-sm-12 col-12">
                        ...
                        <tr>
                         ...
                         <!--  <td class="text-center"><a href="" class="font-14 text-detail">Lihat Detail</a></td> -->
                          ...
                          <td> 
                              ...
                              <a class="mx-3" href="<?php echo base_url('admin/Pasien/tampilEditPasien/'.$pasien->id);?>">
                                <i><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
