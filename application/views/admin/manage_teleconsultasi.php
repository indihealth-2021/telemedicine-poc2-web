  ...
  <div class="content">
      <div class="row mb-4">
          <div class="col-sm-12 col-12 ">
            <nav aria-label="">
                <ol class="breadcrumb" style="background-color: transparent;">
                    ...
                    <li class="breadcrumb-item" aria-current="page"><a href="<?php echo base_url('admin/teleconsultasi') ?>" class="text-black font-bold-7">Jadwal Telekonsultasi</a></li>
                </ol>
            </nav>
          </div>
          <div class="col-sm-12 col-12">
          ...
          <div class="col-sm-12 col-12">
              <h5 class="page-subtitle">Jadwal Telekonsultasi</h3>
          </div>
      </div>
        ...
        <div class="row">
          <div class="col-md-12">
            <!-- <ul class="nav nav-tabs-lg nav-tabs-bottom">
                <li class="nav-item"><a class="nav-link active" href="#jadwal-dokter" data-toggle="tab">Jadwal Telekonsultasi</a></li>
            </ul> -->
                    ...
                    <table class="table table-border table-hover custom-table mb-0" id="table_telekonsultasi">
                      ...
                      <tbody class="font-14">
                        ...
                        <tr>
                          ...
                          <td><span><?php echo ucwords($jt->nama_dokter) ?></span><br>
                            <span class="font-12"><?php echo $jt->poli ?></span>
                          </td>
                          ...
                          <td><?php echo ucwords($jt->jam)?> (Max. <?= $jt->durasi/60 ?> Menit)</td>
                          <td>
                              ...
                              <a class="mx-3" href="<?php echo base_url('admin/Teleconsultasi/tampilEditJadwal/'.$jt->id);?>">
                                <i><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
  ...
  <div class="modal-dialog  modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title font-modal-header p-2">Hapus Data Jadwal Telekonsultasi</h5>
      </div>
      ...
      <div class="modal-body font-modal-body">
          <p class="font-16 p-2 mx-auto">Anda yakin ingin menghapus data jadwal Telekonsultasi <br><b id="nama"></b> ?</p>
      </div>
