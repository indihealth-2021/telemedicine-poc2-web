          ...
          <div class="card">            
            <div class="card-body m-5">
                <table width="100%" class="form">
                                  <tbody>
                                    <tr><td><strong>User Dokter</strong></td></tr>
                                    <tr>
                                          <td>Email</td>
                                          <td>
                      ...
                      <a href="<?php echo base_url('admin/Dokter/tampilEditDokter/'.$user[0]->id);?>"><button type="button" class="btn btn-primary">EDIT</button></a>
                      <a href="<?php echo base_url('admin/Dokter');?>"><button type="button" class="btn btn-primary" id="form-close">KEMBALI</button></a>
                </div>
              </form> 
            </div>
