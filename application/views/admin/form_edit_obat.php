  ...
  <div class="content">
      ...
      <div class="row">
        <div class="col-lg-12">    
          <?= form_open('admin/Obat/update/'.$obat->id); ?> 
          
            <p class="title-form">Edit Obat</p>
            <div class="row">
              <div class="col-md-4">
                <div class="form-group form-focus">
                    <label class="focus-label">Nama Obat</label>
                    <input type="text" class="form-control floating" name="nama" id="" placeholder="nama obat" value="<?php echo $obat->name ?>" required placeholder="Masukan Nama Obat">
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-group form-focus">
                    <label class="focus-label">Satuan Obat</label>
                    <input type="text" class="form-control floating" name="satuan" id="satuan_input" placeholder="satuan" value="<?php echo $obat->unit ?>" required placeholder="Masukan Satuan Obat">
                </div>
              </div> 
            </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-14">
                    <div class="input-group">
                      ...
                      <input type="number" class="form-control" name="harga" id="harga" value="<?php echo $obat->harga ?>" min=1  placeholder="Masukan Harga Obat" required>
                    </div>
                ...
                <div class="form-group gender-select">
                  <div class="form-check-inline">
                    <label class="form-check-label">
                        <input type="radio" class="form-check-input" name="aktif" id="status" value=1 required <?php echo $obat->active ? 'checked' : ''; ?> required>Aktif
                    </label>
                  </div>
                  <div class="form-check-inline pl-5 ml-5">
                    <label class="form-check-label">
                        <input type="radio" class="form-check-input" name="aktif" id="status" value=0 required <?php echo $obat->active == 0 ? 'checked' : ''; ?> required>Non Aktif
                    </label>
                  </div>
                </div>
              </div>
            ...
            <div class="row mt-5">
              <div class="ml-3">
                ...
                <a href="<?php echo base_url('admin/Obat/manage_obat') ?>"><button type="button" class="btn btn-batal ml-4"  id="btn-add-admin">Batal</button></a>
              </div>
            </div>
          <?= form_close(); ?>
        </div>
