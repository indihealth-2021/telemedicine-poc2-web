  ...
  <div class="content">
          ...
          <div class="col-sm-12 col-12 ">
            <nav aria-label="">
                <ol class="breadcrumb" style="background-color: transparent;">
                    ...
                    <li class="breadcrumb-item" aria-current="page"><a href="<?php echo base_url('admin/RumahSakit/form_user_rs') ?>" class="text-black font-bold-7">Tambah User</a></li>
                </ol>
            </nav>
          </div>
      </div>
      <div class="row">
        <div class="col-lg-12">
          <?= form_open_multipart('admin/RumahSakit/tambah_user', 'id="form-add-user" onsubmit="return ubah();" autocomplete="off"'); ?>
            ...
            <div class="row">
              <div class="col-md-4">
                <div class="form-group form-focus">
                    ...
                    <input type="text" class="form-control floating" name="name" id="name" <?php echo isset($old) ? 'value="'.$old['name'].'"' : ''; ?> required placeholder="Masukan Nama Rumah Sakit">
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-4">
                ...
                <div class="form-group form-focus">
                    ...
                    <input type="text" class="form-control floating" name="username" id="username" <?php echo $error == 'username' && $error == 'usernameAndEmail' ? 'value="'.$old['username'].'"' : '' ?> required placeholder="Masukan Username">
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-group form-focus">
                ...
                <div class="form-group gender-select">
                  <div class="form-check-inline">
                    <label class="form-check-label">
                        <input type="radio" class="form-check-input" value='1' name="id_user_level" id="id_user_level" <?php if($old){ echo $old['id_user_level'] == '1' ? 'checked' : ''; } ?> required> Diampu
                    </label>
                  </div>
                  <div class="form-check-inline pl-2">
                    <label class="form-check-label">
                        <input type="radio" class="form-check-input" value='2' name="id_user_level" id="id_user_level" <?php if($old){ echo $old['id_user_level'] == '2' ? 'checked' : ''; } ?> required> Pengampu
                    </label>
                  </div>
                </div>
              </div>
...
<?php echo $this->session->flashdata('msg_add_user') ? "<script>alert('".$this->session->flashdata('msg_add_user')."')</script>" : ''; ?>
