        ...
        <div class="col-md-12">
          <div class="input-group">
            ...
            <div class="input-group-append">
              <button class="btn bg-tele text-light" type="button" id="panggil-dokter" disabled>Panggil</button>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="col-md-12">
          <div class="card card-5 p-1 px-4 pt-3 pb-5">
            ...
            <div class="tab-content">
              ...
              <div class="row mt-2">
                <div class="col-md-12">
                  <button type="button" class="btn btn-outline-danger btn-block" id="btn-stop-farmasi" data-id-user="" data-pd='d'><img src="<?php echo base_url('assets/dashboard/img/end-call.png'); ?>" alt=""> Akhiri Panggilan</button>
                </div>
              </div>
          </div>
  </div>
