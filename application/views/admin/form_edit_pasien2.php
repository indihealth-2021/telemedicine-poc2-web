        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="card">
              ...
              <form method="post" id="form-edit-pasien" onsubmit="return ubah();" action="<?php echo base_url('admin/Pasien/updatePasien/'.$result->data[0]->id) ?>">
              <div class="card-body">
              ...
              <div class="row mb-4 mt-5 justify-content-center">
                <div class="col-lg-4">
                  <button  class="btn btn-primary w-100" style="background-color: #1F60A8"  id="btn-edit-pasien">UBAH</button>
                </div>
                </form> 
                <div class="col-lg-4">
                  <a href="<?php echo base_url('admin/Pasien');?>"><button type="button" style="background-color: #1F60A8" class="btn btn-primary w-100" id="form-close">BATAL</button></a>
                </div>
              </div>  
              </div>
              </div>
