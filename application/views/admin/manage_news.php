          ...
          <div class="col-sm-12 col-12 ">
            <nav aria-label="">
                <ol class="breadcrumb" style="background-color: transparent;">
                    ...
                    <li class="breadcrumb-item" aria-current="page"><a href="<?php echo base_url('admin/news') ?>" class="text-black font-bold-7">Berita</a></li>
                </ol>
            </nav>
          </div>
          <div class="col-sm-12 col-12">
                ...
                <div class="col-md-12">
                  <div class="box">
                      <div class="container-1">
                          ...
                          <input type="search" id="search" placeholder="Cari Berita Disini" />
                      </div>
                    </div>
                  <div class="p-3">
                      <a href="<?php echo base_url('admin/News/formAdd') ?>" class="btn btn btn-tele btn-rounded float-right  "><i class="fa fa-plus"></i> Tambah Berita</a>
                  </div>
                        ...
                        <tr class="odd gradeX">
                          ...
                          <td width="10%"> 
                            <!-- <a class="dropdown-item btn btn-xs btn-default" href="<?php echo base_url('admin/News/viewDetail/'.$data->id) ?>"><i class="fa fa-eye m-r-5"></i> Lihat</a> -->
                              <a class="font-icon" href="#modalHapus" data-toggle="modal" data-href="<?php echo base_url('admin/News/delete/'.$data->id) ?>" data-nama="<?php echo $data->judul ?>" onclick="$('#modalHapus #form')" >
                              ...
                              <a class="mx-3" href="<?php echo base_url('admin/News/formEdit/'.$data->id) ?>">
                                <i><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
  ...
  <div class="modal-dialog   modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title font-modal-header p-3">Hapus Data Berita</h5>
      </div>
      <div class="modal-body  font-modal-body">
          <p class="p-3">Anda yakin ingin menghapus data berita <b id="nama"></b> ?</p>
      </div>
