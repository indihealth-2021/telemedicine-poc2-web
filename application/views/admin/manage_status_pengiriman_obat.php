                        ...
                        <?php foreach($list_resep as $idx=>$resep){ ?>
                          <tr class="text-top">
                            ...
                            <td class="text-center">
                                      <button class="btn btn-kirim" data-link="<?php echo base_url('admin/PengirimanObat/kirim_obat/'.$resep->id_bukti) ?>" data-toggle="modal" data-target="#modalPengiriman">Kirim</button>
                            </td>
                            <td>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title font-modal-header p-3" id="modalPengirimanLabel">Pengiriman Obat</h5>
      </div>
      <div class="modal-body">
        <p class="p-3">Apakah anda yakin akan mengirim barang ini?</p>
      </div>
      <div class="modal-footer">
        <div class="mx-auto">
          <a href="" id="link-delete"><button type="submit" class="btn btn-ya">Yakin</button></a>
