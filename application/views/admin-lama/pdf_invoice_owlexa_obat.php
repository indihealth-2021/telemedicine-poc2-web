        ...
        <table class="table-invoice table-bordered font-5">
          <thead>
            <tr class="text-center">
              ...
              <th width="7%">Benefit Description</th>
            ...
            <?php foreach ($list_pembayaran as $idx => $pembayaran) { ?>
              ...
              <?php for ($i = 0; $i < $jml_data; $i++) { ?>
                <tr>
                  ...
                  <td></td>
                  <td></td>
                  <td><?php echo '<span class="fa fa-dashboard"></span> ' . $list_nama_obat[$i] . ' ( ' . $list_jumlah_obat[$i] . ' ' . $list_tipe_obat[$i] . ' )'; ?></td>
