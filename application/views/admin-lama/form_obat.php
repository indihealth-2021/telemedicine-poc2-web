        ...
        <form method="post" id="form-add-poli" action="<?php echo base_url('admin/Obat/insert') ?>">
          <div class="row">
            ...
            <div class="col-sm-6">
              <div class="form-group">
                <label>Harga</label>
                <input type="number" class="form-control" name="harga" id="harga" min=1 placeholder="harga" required>
              </div>
            </div>
            <div class="col-sm-12">
              <div class="form-group">
                <label for="exampleFormControlSelect1">Status</label>
                <select name="active" class="form-control" id="exampleFormControlSelect1" required>
            ...
            <div class="col-sm-12 mt-2">
              <div class="form-group row">
                <div class="col-sm-12 col-12 alert">
                  <div id="formatHarga">Rp 0,00 / 1 Unit</div>
                </div>
              </div>
            </div>
          </div>
