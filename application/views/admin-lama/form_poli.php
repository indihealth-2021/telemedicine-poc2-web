  ...
  <div class="content">
    <div class="row mb-5">
      <div class="col-sm-5 col-5">
        <h4 class="page-title">Tambah Poli</h4>
      </div>
      ...
      <div class="col-lg-8 offset-lg-2">
        <form method="post" id="form-add-poli" action="<?php echo base_url('admin/Config/addPoli') ?>">
              ...
              <div class="form-group">
                ...
                <div class="col-md-14">
                  <div class="input-group">
                    ...
                    <input type="number" class="form-control" name="biaya_adm" id="biaya_adm" placeholder="biaya administrasi">
                    <div class="input-group-append">
                      <span class="input-group-text">,00</span>
                    </div>
                  </div>
          ...
          <div class="m-t-20 text-center">
            <button class="btn btn-primary submit-btn" id="btn-add-poli">Simpan</button>
          </div>
        </form>
