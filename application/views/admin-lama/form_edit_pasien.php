                    ...
                    <div class="col-lg-8 offset-lg-2">
                        <form method="post" id="form-edit-pasien" onsubmit="return ubah();" action="<?php echo base_url('admin/Pasien/updatePasien/'.$data->id) ?>" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" id="no_medrec" name="no_medrec" value="<?php echo $detail_pasien ? $detail_pasien->no_medrec : '';?>" readonly disabled>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                    ...
                                    <div class="form-group gender-select">
                                        ...
                                        <div class="form-check-inline">
                                            <label class="form-check-label">
                                                <input type="radio" name="jenis_kelamin" class="form-check-input" value="laki-laki" <?php if($data->jenis_kelamin == "Laki-laki")echo "checked";?>  required>
                                                <i class="fa fa-male fa-fw"></i> Laki-laki
                                            </label>
                                        </div>
                                        <div class="form-check-inline">
                                            <label class="form-check-label">
                                                <input type="radio" name="jenis_kelamin" class="form-check-input" value="perempuan" <?php if($data->jenis_kelamin == "Perempuan")echo "checked";?>  required>
                                ...
                                <div class="col-sm-12">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control"  class="form-control" name="kode_pos" id="kode_pos" value="<?php echo $data->kode_pos;?>">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label>Jalan</label>
                                            <input type="text" class="form-control" name="alamat_jalan" id="alamat_jalan" value="<?php echo $data->alamat_jalan;?>">
                                         </div>
                                    </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                            ...
                            <div class="m-t-20 text-center">
                                <button class="btn btn-primary submit-btn" id="btn-edit-pasien">Edit</button>
                            </div>
                        </form>
                    </div>
                </div>
