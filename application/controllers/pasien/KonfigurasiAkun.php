...
class KonfigurasiAkun extends CI_Controller {
	...
	public function index(){
		...
		$data['view'] = 'pasien/menu_konfigurasi_akun';
		$data['title'] = 'Konfigurasi Akun';
		$data['user'] = $this->all_model->select('master_user', 'row', 'id = '.$this->db->escape($this->session->userdata('id_user')));
	...
	public function form_username(){
		...
		$data['view'] = 'pasien/form_konfigurasi_username';
	...
	public function form_password(){
		...
		$data['view'] = 'pasien/form_konfigurasi_password';
	...
	public function update_password(){
		...
		if(!password_verify($data['passwordlama'], $user->password))
		{
			...
			redirect(base_url('pasien/KonfigurasiAkun/form_password'));
		}
		else{
